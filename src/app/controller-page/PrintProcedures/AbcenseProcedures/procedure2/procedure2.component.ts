...
@Component({
  ...
  styleUrls: ['./procedure2.component.css']
})
export class Procedure2Component implements OnInit, OnDestroy{
  
  employees: ProcedureDetail[];
  orgDetails: OrgDetails;
  procedureSub: Subscription;
  orgSub: Subscription;
  days:string="أربعة أيام";
  proName:string="تعهد خطي لغياب أيام بدون عذر"
  text:string="نظراً لتكرار غيابك أربعة أيام وجب تنبيهك خطياً وأخذ تعهد خطي عليك"
